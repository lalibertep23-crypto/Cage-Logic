    ...
    <main style={{ background: '#050505', minHeight: '100vh', color: '#F2EFE8', paddingBottom: 80 }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          <div style={{ width: 3, height: 22, background: '#5C8A3C' }} />
          <div>
        ...
        <Link href="/mental" style={{ fontFamily: 'var(--font-dm-mono)', fontSize: 9, letterSpacing: '0.12em', color: 'rgba(242,239,232,0.35)', textDecoration: 'none' }}>
          ← MENTAL
        </Link>
      </div>

      <div style={{ padding: '24px 22px 0' }}>
        <div style={{ borderLeft: '3px solid rgba(42,92,63,0.4)', padding: '14px 14px 14px 12px', background: '#111111', marginBottom: 24 }}>
